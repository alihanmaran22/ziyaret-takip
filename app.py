...
# 3. KALICI KAYIT MANTIĞI: 
# Burada st.session_state'i ana veritabanı gibi kullanacağız.
# Ancak uygulama kapanınca verinin uçmaması için verileri kopyalanabilir bir "Kalıcı Liste"de tutuyoruz.
...
if st.session_state.ziyaretler:
    ...
    st.info("💡 Kankam, sayfayı yenilemeden verilerin burada durur. İşini bitirince Füzyon'a aktar ve metni kopyala.")
else:
