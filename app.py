...
# Özel anahtarını değişken olarak tanımladık, secrets ile uğraşmıyoruz
...
# JSON nesnesini kod içinde oluşturuyoruz (Hata riskini sıfırladık)
creds_dict = {
...
st.write("Excel'deki mevcut kayıtlar:", sheet.get_all_values())
